...
In simple situations (this site for example) CSS will do the trick. But what if dynamic content at the top of your page changes this calculation (a flash or notification message for example)? Or your header likes to changes size?
...
Let’s revisit our first block of code, basing the calculation on the size of a div above it (a header for example):
