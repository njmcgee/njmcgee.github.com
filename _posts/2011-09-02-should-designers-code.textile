...
"Frank Chimero":http://blog.frankchimero.com/post/9594863189 and "Andy Rutledge":http://andyrutledge.com/web-design-is-product-design.php have both recently answered this question with a big fat <b>YES</b>. 

I completely agree. You don’t get to call yourself a web designer if you’re illiterate in HTML & CSS (let’s not get bogged down in whether this is ‘coding’ or not).

The discussion seems to come around regularly and it’s surprising that there is actual resistance to this idea (see "Rutledge’s article":http://andyrutledge.com/web-design-is-product-design.php for a succinct rebuttal). 
